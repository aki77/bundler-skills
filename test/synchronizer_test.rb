...
class SynchronizerTest < Minitest::Test
  ...
  # Most dependency gems ship no skills. A sync that discovers nothing and
  # changes nothing must stay completely silent instead of printing
  # "0 skill(s) discovered, 0 linked ...".
